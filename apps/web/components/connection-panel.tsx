  ...
  return (
    <main className="mx-auto flex min-h-svh w-full max-w-lg flex-col justify-center gap-6 p-6">
      <header className="flex flex-col gap-2">
        <p className="text-sm font-medium text-muted-foreground">Homescreen</p>
          ...
          {hasConnection ? (
            <div className="flex flex-col gap-2">
              ...
              {status === "connected" ? (
                ...
                <p className="text-sm text-muted-foreground">
                  Waiting for Home Assistant. Updates will resume when the
                  connection returns.
                </p>
              )}
            </div>
            ...
            <form onSubmit={submit}>
              <FieldGroup>
                <Field data-disabled={busy}>
                  <FieldLabel htmlFor="instance">Instance URL</FieldLabel>
                  <Input
                    id="instance"
                    name="instance"
                    type="url"
                  ...
                  <FieldDescription id="instance-help">
                    Use an address this browser can reach. An HTTPS app needs an
                    HTTPS Home Assistant address.
                  </FieldDescription>
                </Field>
