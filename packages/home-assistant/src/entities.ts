...
export function applyEntityUpdates(
  ...
  if (update.a !== undefined) {
    for (const [id, value] of Object.entries(record(update.a))) {
      ...
      entities[id] = {
        ...
        last_updated:
          compressed.lu === undefined ? changed : timestamp(compressed.lu),
      };
    }
  }
  if (update.r !== undefined) {
    if (!Array.isArray(update.r)) throw new Error("Invalid entity removals");
  ...
  if (update.c !== undefined) {
    for (const [id, value] of Object.entries(record(update.c))) {
      ...
      if (plus.s !== undefined) {
        if (typeof plus.s !== "string") throw new Error("Invalid entity state");
        next.state = plus.s;
      }
      if (plus.c !== undefined)
      ...
      } else if (plus.lu !== undefined) next.last_updated = timestamp(plus.lu);
      if (plus.a !== undefined || minus.a !== undefined) {
        ...
        if (minus.a !== undefined) {
          ...
          for (const key of minus.a as string[]) delete next.attributes[key];
        }
      }
      entities[id] = next;
    }
